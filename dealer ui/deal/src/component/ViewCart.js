...
paymentProcess(){
    this.crops.history.push('/stripe');
}
    render() {
        return (
                <div>
                 <h2 className="text-center" style={{paddingTop:"100px"}}>Cart Crop List</h2>
                 <div className = "row">
                 </div>
                 <br></br>
                 <div className = "row">
                            ...
                            <tbody>
                                {
                                    this.state.cart.map(
                                        ...
                                        <tr key = {carts.id} style={{color:'black',backgroundColor:"#98BF64"}}>
                                             ...
                                             <StripeButton  style={{marginLeft: "10px",borderRadius:"12px"}}  price={carts.totalPrice} onClick={this.paymentProcess}>Payment</StripeButton>
